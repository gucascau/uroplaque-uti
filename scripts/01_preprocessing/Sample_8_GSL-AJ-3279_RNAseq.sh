...
in=/home/gdbecknelllab/xxw004/Projects/Becknell/MicroRNA/Datasets_v010324/RNAseq/231107_Becknell_GSL-MK-3651/${id}

out=/home/gdbecknelllab/xxw004/Projects/Becknell/MicroRNA/Datasets_v010324/RNAseq/231107_Becknell_GSL-MK-3651/${id}
...
#
cat $in/${id}/${id}${Substr}${read1In1}.gz $in/${id}/${id}${Substr}${read1In2}.gz  >${in}/${id}${read1}.gz
cat $in/${id}/${id}${Substr}${read2In1}.gz $in/${id}/${id}${Substr}${read2In2}.gz  >${in}/${id}${read2}.gz
#
